  ...
  return (
    <div>
      <Row className="p-4 mb-4">
        <Col className="about-container p-2">
          <h1>ABOUT </h1>
        ...
        <Col className="p-4">
          <Row className="mb-4 p-4 experience-container ">
            <Col className="text-center p-4">
              <span style={{ fontSize: "7rem" }}>
                <SiOnlyoffice />
              </span>
            </Col>
            <Col className="experience-container">
              <h1>Experience</h1>
              <p>
          ...
          <Row className="mb-4 p-4 education-container">
          ...
          <Row className="mb-4 p-4 future-container">
            <Col className="text-center">
              <span className="" style={{ fontSize: "7rem" }}>
                <GiStairsGoal />
              </span>
            </Col>
            <Col  className="future-container">
              <h1>Future Goals</h1>
              <p>
